...
public class ClientWeb1 {
	...
	public static void f1() {
		...
		int index = 16;
		int uid = 8140393;
		String sid = "6c977bd0a5808fa04d1c0d5a9eff779e";
		// String sid = "2f1cfa82e0f306528827ea1f93565e88";
		// int uid = 8139879;
		...
		Send expelTable = new Send();
		expelTable.setCmd(795);
		Send quickInto = new Send();
		quickInto.setCmd(798);
		...
		try {
			...
			do {
				...
				} else if (string.equals("expelt")) {
					session.getBasicRemote().sendText(gson.toJson(expelTable));
				} else if (string.equals("qucik")) {
					session.getBasicRemote().sendText(gson.toJson(quickInto));
				}
			} while (true);
